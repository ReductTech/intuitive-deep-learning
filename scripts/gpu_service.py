"""Bounded local training and inference operations for teaching modules."""
...
from dataset_service import *  # Re-export the established dataset and feature contract.
...
def face_embedding_similarity(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if INSIGHTFACE_APP is None:
        raise RuntimeError("InsightFace app is not initialized. Start http_service.py before requesting similarity.")
