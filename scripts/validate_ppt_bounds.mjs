...
const slideIds = ['nematode-response', 'biological-structure', 'decision-bridge', 'signal-discovery', 'weighted-sum', 'extra-inputs', 'weighted-contribution', 'bias-natural-boundary', 'bias-threshold', 'linear-shallow', 'nematode-xor', 'relu-intro', 'relu-explanation', 'relu-network', 'relu-approximation', 'activation-catalog', 'ending', 'resources'];
