...
import { PresentationSpikePage } from '../../modules/Presentation-Spike/PresentationSpikePage';
...
function HomePage() {
  return <ModuleShell title="Intuitive Deep Learning" subtitle="从真实问题出发，逐步建立可解释的数学模型。" shellClassName="app-home-shell">
    ...
    <ContentBlock className="app-developer-tools" title="开发工具" subtitle="共享组件检查、演示编辑与 Web PPT 播放入口。"><div className="app-developer-tools__grid"><AppLink className="app-ui-kit-card" to="/shared/ui-kit"><span className="edu-badge">设计系统</span><strong>Shared UI Kit</strong><span>检查共享组件、流程控制和题型。</span><em>打开 →</em></AppLink><AppLink className="app-ui-kit-card" to="/presentation-spike"><span className="edu-badge">演示编辑</span><strong>Presentation Studio</strong><span>新建、打开并保存演示项目。</span><em>打开 →</em></AppLink><a className="app-ui-kit-card" href="/web_ppt/"><span className="edu-badge">演示入口</span><strong>Web PPT</strong><span>播放 React 课件或本地 PPT。</span><em>打开 →</em></a></div></ContentBlock>
  </ModuleShell>;
}

export const appRoutes: AppRoute[] = [
  { path: '/', element: <HomePage /> },
  { path: '/presentation-spike', element: <PresentationSpikePage /> },
  { path: '/presentation-spike/neuron', element: <NeuronPresentationSpikePage /> },
